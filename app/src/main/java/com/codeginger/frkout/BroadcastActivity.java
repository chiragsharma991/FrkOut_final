...
public class BroadcastActivity extends ActionBarActivity implements ActionBar.TabListener
{
    ...
    // which will keep every loaded fragment in memory. If this becomes too memory intensive, it may be best to switch to a {@link android.support.v4.app.FragmentStatePagerAdapter}.
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter
    {
        ...
        public Fragment getItem(int position)
        {
            ...
            {
                case 0:
                    return new BroadcastCampaignFragment();
                case 1:
                    return new BroadcastTargetAudience();
                case 2:
                    return new BroadcastCreativeFragment();
            }
            return null;
        ...
        public CharSequence getPageTitle(int position)
        {
            ...
            switch (position)
            {
                case 0:return getString(R.string.title_activity_broadcast_campaign).toUpperCase(l);
                case 1:return getString(R.string.title_activity_broadcast_audience).toUpperCase(l);
                case 2:return getString(R.string.title_activity_broadcast_creative).toUpperCase(l);
            }
            return null;
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.action_broadcast_clear)
        {
            usm.BroadcastClear();
            dbHelper.deleteBrodCamp();
