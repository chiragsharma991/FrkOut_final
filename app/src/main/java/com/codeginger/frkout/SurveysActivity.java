...
public class SurveysActivity extends ActionBarActivity implements ActionBar.TabListener
{
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter
    {
        ...
        public Fragment getItem(int position)
        {
            ...
            {
                case 0:
                    return new  SurveysActiveFragment();
                case 1:
                    return new  SurveysIncompleteFragment();
                case 2:
                    return new  SurveysCompletedFragment();
            }
            return null;
        ...
        public CharSequence getPageTitle(int position)
        {
            ...
            {
                case 0:
                    return getString(R.string.title_activity_surveys_active).toUpperCase(l);
                case 1:
                    return getString(R.string.title_activity_surveys_incomplete).toUpperCase(l);
                case 2:
                    return getString(R.string.title_activity_surveys_completed).toUpperCase(l);
            }
            return null;
        }
    }
